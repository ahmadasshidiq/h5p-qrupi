...
const start = async (): Promise<void> => {
    ...
    // Expose a CSRF token for external clients (for example, an LMS running
    // on another frontend origin) before they make state-changing H5P calls.
    server.get('/h5p/csrf-token', csrfProtection, (req, res) => {
